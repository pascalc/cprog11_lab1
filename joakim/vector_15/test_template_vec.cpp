...
int main()
{
    ...
    // NO COMPILE vc[0] = 3.1415;             // fel: tilldelning av konstant objekt
    // NO COMPILE Vector<char> c = v;         // fel: tilldelning av olika typer
    // NO FUNCTION MATCH vc.sort();                  // fel: ändrar konstant objekt
