...
public:
 TestDescription_MyTestSuite_testPushBack() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 63, "testPushBack" ) {}
...
public:
 TestDescription_MyTestSuite_testInsert() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 83, "testInsert" ) {}
...
public:
 TestDescription_MyTestSuite_testErase() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 95, "testErase" ) {}
...
public:
 TestDescription_MyTestSuite_testNonConstAssignment() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 122, "testNonConstAssignment" ) {}
...
public:
 TestDescription_MyTestSuite_testConst() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 137, "testConst" ) {}
...
public:
 TestDescription_MyTestSuite_testSelfAssignment() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 145, "testSelfAssignment" ) {}
...
public:
 TestDescription_MyTestSuite_testExceptionOutOfRange() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 151, "testExceptionOutOfRange" ) {}
